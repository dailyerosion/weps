...
write(unit=*,fmt="(1x,2a)") ">>Begin Element: ", name
write(unit=*,fmt="(1x,a,i2,a)") "--- ", len(attributes), " attributes:"
...
write(unit=*,fmt="(1x,a)",advance="no") trim(chunk)
...
write(unit=*,fmt="(1x,2a)") ">>Empty Element: ", name
write(unit=*,fmt="(1x,a,i2,a)") "--- ", len(attributes), " attributes:"
call print_dict(attributes)
write(unit=*,fmt="(1x,2a)") ">>-------------End Empty Element: ", trim(name)
...
write(unit=*,fmt="(1x,a)") ">>Comment: "
write(unit=*,fmt="(1x,a)") trim(comment)
...
!
 write(unit=*,fmt="(1x,2a)") ">>XML declaration: ", name
 call print_dict(attributes)
...
!
write(unit=*,fmt="(1x,a)") ">>SGML declaration: "
write(unit=*,fmt="(1x,a)") trim(sgmldecl)

end subroutine sgml_declaration_handler
!--------------------------------------------------

end module m_handlers_features
