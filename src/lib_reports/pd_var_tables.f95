...
MODULE pd_var_tables
    ...
    INTEGER, PARAMETER :: N_cli_vars      = 5
    ...
    INTEGER, PARAMETER :: Salt_1          =  5 + Max_cli_vars
    INTEGER, PARAMETER :: Salt_2          =  6 + Max_cli_vars
    INTEGER, PARAMETER :: Salt_3          =  7 + Max_cli_vars
    INTEGER, PARAMETER :: Salt_4          =  8 + Max_cli_vars
    INTEGER, PARAMETER :: Susp_1          =  9 + Max_cli_vars
    INTEGER, PARAMETER :: Susp_2          = 10 + Max_cli_vars
    INTEGER, PARAMETER :: Susp_3          = 11 + Max_cli_vars
    INTEGER, PARAMETER :: Susp_4          = 12 + Max_cli_vars
    INTEGER, PARAMETER :: PM10_1          = 13 + Max_cli_vars
    INTEGER, PARAMETER :: PM10_2          = 14 + Max_cli_vars
    INTEGER, PARAMETER :: PM10_3          = 15 + Max_cli_vars
    INTEGER, PARAMETER :: PM10_4          = 16 + Max_cli_vars
    INTEGER, PARAMETER :: N_eros_events   = 17 + Max_cli_vars

    INTEGER, PARAMETER :: N_eave_vars     = 17
    ...
    INTEGER, PARAMETER :: N_eop_vars      = 34
