...
contains
  ...
  subroutine setup_man_xml()
   ...
   ! assign tag names
    ...
    max_ogp = 58   ! count of total number of operations, groups, and processes
    sum_stat = 0
    ...
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(24)%r_name(5), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(24)%s_name(0), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(24)%r_name(1)="rstore"
    param_nt(24)%r_name(2)="rleaf"
    param_nt(24)%r_name(3)="rstem"
    param_nt(24)%r_name(4)="rrootstore"
    param_nt(24)%r_name(5)="rrootfiber"
    ...
    param_nt(39)%ogp="P"
    param_nt(39)%id = 72
    allocate( param_nt(39)%i_name(2), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(39)%r_name(6), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(39)%s_name(0), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(39)%i_name(1)="irrmonflag"
    param_nt(39)%i_name(2)="irrminint"
    ...
    param_nt(43)%ogp="P"
    param_nt(43)%id = 92
    allocate( param_nt(43)%i_name(0), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(43)%r_name(2), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(43)%s_name(0), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(43)%r_name(1)="wcdepth"
    param_nt(43)%r_name(2)="wc"

    ! planting location
    param_nt(44)%ogp="P"
    param_nt(44)%id = 101
    allocate( param_nt(44)%i_name(2), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(44)%r_name(1), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(44)%s_name(0), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(44)%i_name(1)="rowflag"
    param_nt(44)%r_name(1)="rowspac"
    param_nt(44)%i_name(2)="rowridge"
    ...
    param_nt(45)%r_name(1)="plantpop"
    param_nt(45)%r_name(2)="dmaxshoot"
    param_nt(45)%i_name(2)="cbaflag"
    param_nt(45)%r_name(3)="tgtyield"
    param_nt(45)%r_name(4)="cbafact"
    param_nt(45)%i_name(3)="hyldflag"
    param_nt(45)%s_name(2)="hyldunits"
    param_nt(45)%r_name(5)="hyldwater"
    param_nt(45)%r_name(6)="hyconfact"
    param_nt(45)%i_name(4)="idc"
    param_nt(45)%r_name(7)="grf"
    param_nt(45)%r_name(8)="ck"
    ...
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(46)%r_name(8), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(46)%s_name(1), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(46)%s_name(1)="stage_label"
    param_nt(46)%i_name(1)="stage_type"
    param_nt(46)%r_name(1)="swc_curve1"
    param_nt(46)%r_name(2)="swc_curve2"
    param_nt(46)%r_name(3)="swc_curve3"
    param_nt(46)%r_name(4)="swc_curve4"
    param_nt(46)%r_name(5)="gdd_resp1"
    param_nt(46)%r_name(6)="gdd_resp2"
    param_nt(46)%r_name(7)="gdd_resp3"
    param_nt(46)%r_name(8)="gdd_resp4"
    ...
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(47)%r_name(18), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    ...
    param_nt(47)%r_name(9)="beg_senes_root"
    param_nt(47)%r_name(10)="end_senes_root"
    param_nt(47)%r_name(11)="beg_grain_index"
    param_nt(47)%r_name(12)="end_grain_index"
    param_nt(47)%r_name(13)="beg_p_rw"
    param_nt(47)%r_name(14)="end_p_rw"
    param_nt(47)%r_name(15)="beg_p_lf"
    param_nt(47)%r_name(16)="end_p_lf"
    param_nt(47)%r_name(17)="beg_p_rp"
    param_nt(47)%r_name(18)="end_p_rp"
    ...
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(48)%r_name(18), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    ...
    param_nt(48)%r_name(9)="beg_senes_root"
    param_nt(48)%r_name(10)="end_senes_root"
    param_nt(48)%r_name(11)="beg_grain_index"
    param_nt(48)%r_name(12)="end_grain_index"
    param_nt(48)%r_name(13)="beg_p_rw"
    param_nt(48)%r_name(14)="end_p_rw"
    param_nt(48)%r_name(15)="beg_p_lf"
    param_nt(48)%r_name(16)="end_p_lf"
    param_nt(48)%r_name(17)="beg_p_rp"
    param_nt(48)%r_name(18)="end_p_rp"
    ...
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(49)%r_name(18), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    ...
    param_nt(49)%r_name(5)="height_inc"
    param_nt(49)%r_name(6)="root_depth_inc"
    param_nt(49)%r_name(7)="beg_live_leaf"
    param_nt(49)%r_name(8)="end_live_leaf"
    param_nt(49)%r_name(9)="beg_senes_root"
    param_nt(49)%r_name(10)="end_senes_root"
    param_nt(49)%r_name(11)="beg_grain_index"
    param_nt(49)%r_name(12)="end_grain_index"
    param_nt(49)%r_name(13)="beg_p_rw"
    param_nt(49)%r_name(14)="end_p_rw"
    param_nt(49)%r_name(15)="beg_p_lf"
    param_nt(49)%r_name(16)="end_p_lf"
    param_nt(49)%r_name(17)="beg_p_rp"
    param_nt(49)%r_name(18)="end_p_rp"
    ...
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(50)%r_name(19), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(50)%s_name(1), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(50)%s_name(1)="stage_label"
    param_nt(50)%i_name(1)="stage_type"
    param_nt(50)%r_name(1)="GN_trans_gdd"
    param_nt(50)%r_name(2)="GN_stress"
    param_nt(50)%r_name(3)="GS_trans_gdd"
    param_nt(50)%r_name(4)="GS_stress"
    param_nt(50)%r_name(5)="tverndel"
    param_nt(50)%r_name(6)="height_inc"
    param_nt(50)%r_name(7)="root_depth_inc"
    param_nt(50)%r_name(8)="beg_live_leaf"
    param_nt(50)%r_name(9)="end_live_leaf"
    param_nt(50)%r_name(10)="beg_senes_root"
    param_nt(50)%r_name(11)="end_senes_root"
    param_nt(50)%r_name(12)="beg_grain_index"
    param_nt(50)%r_name(13)="end_grain_index"
    param_nt(50)%r_name(14)="beg_p_rw"
    param_nt(50)%r_name(15)="end_p_rw"
    param_nt(50)%r_name(16)="beg_p_lf"
    param_nt(50)%r_name(17)="end_p_lf"
    param_nt(50)%r_name(18)="beg_p_rp"
    param_nt(50)%r_name(19)="end_p_rp"
    ...
    param_nt(57)%r_name(1)="frsx1"
    param_nt(57)%r_name(2)="frsx2"
    param_nt(57)%r_name(3)="frsy1"
    param_nt(57)%r_name(4)="frsy2"

    ! weps_regrowth
    param_nt(58)%ogp="P"
    param_nt(58)%id = 230
    allocate( param_nt(58)%i_name(1), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(58)%r_name(4), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    allocate( param_nt(58)%s_name(1), stat=alloc_stat )
    sum_stat = sum_stat + alloc_stat
    param_nt(58)%s_name(1)="process_label"
    param_nt(58)%i_name(1)="process_type"
  ...
  subroutine pcdata_man_chunk_handler(chunk)
    ...
    if (man_tag(wepsmanDB)%in_tag) then
      if (man_tag(version)%in_tag) then
        ...
        write (6,"(a26,f11.5)") 'Management file version: ', manFile(isub)%mversion
        ...
        if (man_tag(date)%in_tag) then
          call read_param(man_tag(date)%name, param_value, '/', t_operDate%day, t_operDate%month, t_operDate%year )
 ...
 10   read(luimanfile, '(a)', end=20) line
      ...
      case ('V')  ! first line begins with word "Version: "
        ...
        if (line (1:8).eq.'Version: ') then
          ...
          ! Report the version to stdout
          write (6,"(a26,f4.2)") 'Management file version: ', manFile(isub)%mversion
          ...
          if (manFile(isub)%mversion .lt. 1.40) then
            write(0,"(a26,f4.2)") 'Management file version: ', manFile(isub)%mversion
            write(0,"(a46)") 'Version >= 1.40 is required for this release.'
            write(0,"(a21,a)") 'You need to convert ', trim(manFile(isub)%tinfil)
            write(0,"(a24)") ' to the correct format.'
            call exit (1)
          end if
        else
      ...
      case ('P')
        ...
        case (35)
          ...
          linidx = linidx + 1
          call readValues(manFile(isub)%proc, line, 'rstore', 'rleaf', 'rstem', 'rrootstore', 'rrootfiber')
